  ...
  exports['default'] = _ember['default'].Route.extend({
    ...
    model: function model(params) {
      ...
      return this.store.query('town', { name: params.town_name }).then(function (town) {
        ...
        _this.set('mapRouter.boundsOptions', { maxZoom: 0, paddingBottomRight: [0, 0] });
...
define("cool-places/templates/application", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["content", "header-menu", ["loc", [null, [1, 0], [1, 15]]]], ["content", "alert", ["loc", [null, [4, 2], [4, 11]]]], ["content", "outlet", ["loc", [null, [5, 2], [5, 12]]]]],
      locals: [],
      templates: []
    };
  })());
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      ...
      return {
        ...
        statements: [["inline", "tile-layer", [], ["url", "http://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png"], ["loc", [null, [4, 4], [4, 83]]]], ["block", "each", [["get", "model", ["loc", [null, [5, 14], [5, 19]]]]], [], 0, null, ["loc", [null, [5, 6], [11, 15]]]], ["block", "if", [["get", "geolocation.currentLocation", ["loc", [null, [12, 10], [12, 37]]]]], [], 1, null, ["loc", [null, [12, 4], [14, 11]]]]],
        locals: [],
        templates: [child0, child1]
      };
    })();
    return {
      ...
      statements: [["block", "leaflet-map", [], ["id", "map", "scrollWheelZoom", false, "bounds", ["subexpr", "@mut", [["get", "mapBounds", ["loc", [null, [3, 55], [3, 64]]]]], [], []], "fitBoundsOptions", ["subexpr", "@mut", [["get", "fitBoundsOptions", ["loc", [null, [3, 82], [3, 98]]]]], [], []], "panning", false], 0, null, ["loc", [null, [3, 2], [15, 18]]]], ["content", "outlet", ["loc", [null, [17, 2], [17, 12]]]]],
      locals: [],
      templates: [child0]
    };
  })());
...
define("cool-places/templates/places/place", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["attribute", "href", ["concat", ["https://www.google.com/maps/dir//", ["get", "model.latitude", ["loc", [null, [2, 46], [2, 60]]]], ",+", ["get", "model.longitude", ["loc", [null, [2, 66], [2, 81]]]]]]], ["content", "model.name", ["loc", [null, [5, 8], [5, 22]]]], ["content", "model.place_type", ["loc", [null, [6, 4], [6, 24]]]], ["content", "model.address", ["loc", [null, [6, 27], [6, 44]]]], ["block", "if", [["get", "model.phone", ["loc", [null, [9, 10], [9, 21]]]]], [], 0, null, ["loc", [null, [9, 4], [11, 11]]]]],
      locals: [],
      templates: [child0]
    };
  })());
