    ...
    model: function model() {
      return new _ember['default'].RSVP.hash({
        heat_alert: _ember['default'].$.ajax({
          url: 'http://api.wunderground.com/api/7a00b70d60a1ac6b/alerts/q/MA/Boston.json', type: 'GET'
        ...
        forecast: _ember['default'].$.ajax({
          url: 'http://api.wunderground.com/api/7a00b70d60a1ac6b/forecast/q/MA/Boston.json', type: 'GET'
        }).then(function (response) {
          return response.forecast.simpleforecast.forecastday[0].high.fahrenheit;
        }),
        current_temp: _ember['default'].$.ajax({
          url: 'http://api.wunderground.com/api/7a00b70d60a1ac6b/conditions/q/MA/Boston.json', type: 'GET'
        }).then(function (response) {
  ...
  exports['default'] = _ember['default'].Route.extend({
    ...
    model: function model(params) {
      ...
      return this.store.find('place', params.place_id).then(function (model) {
        _this.set('mapRouter.boundsOptions', { maxZoom: 15, paddingBottomRight: [0, 150] });
        return model;
      });
    },
    setupController: function setupController(controller, model) {
...
define("cool-places/templates/index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      ...
      var child2 = (function () {
        ...
        return {
          ...
          statements: [["block", "each", [["get", "model.towns", ["loc", [null, [17, 14], [17, 25]]]]], [], 0, null, ["loc", [null, [17, 6], [21, 15]]]]],
          locals: [],
          templates: [child0]
        };
      })();
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("div");
          dom.setAttribute(el1, "class", "ui horizontal inverted divider");
    ...
    return {
      ...
      statements: [["block", "splash-weather", [], ["heat_alert", ["subexpr", "@mut", [["get", "model.weather.heat_alert", ["loc", [null, [2, 31], [2, 55]]]]], [], []]], 0, null, ["loc", [null, [2, 2], [24, 21]]]]],
      locals: [],
      templates: [child0]
    };
  })());
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("li");
        var el4 = dom.createTextNode("High body temperature (above 103°F)*");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
...
define("cool-places/templates/places", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["block", "leaflet-map", [], ["id", "map", "scrollWheelZoom", false, "zoomControl", false, "bounds", ["subexpr", "@mut", [["get", "mapBounds", ["loc", [null, [3, 73], [3, 82]]]]], [], []], "fitBoundsOptions", ["subexpr", "@mut", [["get", "fitBoundsOptions", ["loc", [null, [3, 100], [3, 116]]]]], [], []], "dragging", false], 0, null, ["loc", [null, [3, 2], [11, 18]]]], ["content", "outlet", ["loc", [null, [13, 2], [13, 12]]]]],
      locals: [],
      templates: [child0]
    };
  })());
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        var child0 = (function () {
          return {
            ...
            statements: [["content", "place.name", ["loc", [null, [9, 10], [9, 24]]]], ["content", "place.place_type", ["loc", [null, [9, 27], [9, 47]]]]],
            locals: [],
            templates: []
          };
        })();
        return {
          ...
          statements: [["block", "link-to", ["places.place", ["get", "place", ["loc", [null, [8, 34], [8, 39]]]]], ["class", "item"], 0, null, ["loc", [null, [8, 8], [10, 20]]]]],
          locals: [],
          templates: [child0]
        };
      })();
      return {
        ...
        statements: [["block", "if", [["get", "place.nearby", ["loc", [null, [7, 12], [7, 24]]]]], [], 0, null, ["loc", [null, [7, 6], [11, 13]]]]],
        locals: ["place"],
        templates: [child0]
      };
    })();
    return {
      ...
      statements: [["block", "each", [["get", "model.places", ["loc", [null, [6, 12], [6, 24]]]]], [], 0, null, ["loc", [null, [6, 4], [12, 13]]]]],
      locals: [],
      templates: [child0]
    };
  })());
