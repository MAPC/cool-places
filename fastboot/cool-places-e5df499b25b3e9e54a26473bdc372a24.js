...
define('cool-places/adapters/town', ['exports', 'ember-data', 'cool-places/config/environment'], function (exports, _emberData, _coolPlacesConfigEnvironment) {
  exports['default'] = _emberData['default'].CartoDBAdapter.extend({
    accountName: 'mapc-maps',
    tablePrefix: 'heatwaveapp',
    findAll: function findAll(store, type) {
      ...
      var queryTpl = "SELECT heatwaveapp_towns.name, heatwaveapp_towns.municipal, heatwaveapp_towns.cartodb_id, ST_Simplify(heatwaveapp_towns.the_geom,0.001), heatwaveapp_places.the_geom AS the_geom FROM {{table}}, heatwaveapp_places WHERE heatwaveapp_towns.municipal IN ('" + _coolPlacesConfigEnvironment['default'].MMC_towns.join("','") + "')",
          url = this.buildURL(type, queryTpl),
          response = {};
...
define('cool-places/controllers/index', ['exports', 'ember', 'cool-places/utils/group-by'], function (exports, _ember, _coolPlacesUtilsGroupBy) {
  exports['default'] = _ember['default'].Controller.extend({
    geolocation: _ember['default'].inject.service(),
    grouped: (0, _coolPlacesUtilsGroupBy['default'])('municipal', 'content.towns'),
    actions: {
...
define('cool-places/mixins/reset-scroll', ['exports', 'ember'], function (exports, _ember) {
...
define('cool-places/routes/index', ['exports', 'ember', 'cool-places/utils/group-by'], function (exports, _ember, _coolPlacesUtilsGroupBy) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model() {
...
define('cool-places/routes/info', ['exports', 'ember', 'cool-places/mixins/reset-scroll'], function (exports, _ember, _coolPlacesMixinsResetScroll) {
  exports['default'] = _ember['default'].Route.extend(_coolPlacesMixinsResetScroll['default'], {
    activate: function activate() {
...
define('cool-places/routes/places/nearby', ['exports', 'ember'], function (exports, _ember) {
  ...
  exports['default'] = _ember['default'].Route.extend({
    geolocation: _ember['default'].inject.service(),
    mapRouter: _ember['default'].inject.service(),
    userdatacollection: _ember['default'].inject.service(),
    ...
    model: function model(params) {
      ...
      if (this.get('geolocation.currentLocation')) {
        ...
        var currentLocation = this.get('geolocation').getLocation().then(function (object) {
          _this.get('userdatacollection').sendData(object);
        }, function (error) {
          console.log(error);
...
define('cool-places/services/userdatacollection', ['exports', 'ember', 'cool-places/config/environment'], function (exports, _ember, _coolPlacesConfigEnvironment) {
  exports['default'] = _ember['default'].Service.extend({
    ajax: _ember['default'].inject.service(),
    sendData: function sendData(geo_object) {
      console.log(geo_object, _coolPlacesConfigEnvironment['default']);
      var geojson = {
        "type": "Point",
      ...
      if (_coolPlacesConfigEnvironment['default'].datacollection) {
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    var child1 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.setAttribute(el1, "class", "item menu-item-blue");
          var el2 = dom.createTextNode("\n      ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("i");
          dom.setAttribute(el2, "class", "unordered list icon");
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
        ...
        statements: [["element", "action", ["openModal", "legend"], [], ["loc", [null, [18, 7], [18, 38]]]], ["element", "action", ["openModal", "learn"], [], ["loc", [null, [21, 7], [21, 37]]]]],
        locals: [],
        templates: []
      };
    })();
    var child2 = (function () {
      ...
      return {
        ...
        statements: [["block", "link-to", ["index"], ["class", "cancel item"], 0, null, ["loc", [null, [34, 4], [36, 16]]]], ["block", "link-to", ["places.nearby"], ["class", "cancel item"], 1, null, ["loc", [null, [37, 4], [39, 16]]]], ["block", "link-to", ["info.heat-safety"], ["class", "cancel item"], 2, null, ["loc", [null, [40, 4], [42, 16]]]], ["block", "link-to", ["info.why-is-it-so-hot"], ["class", "cancel item"], 3, null, ["loc", [null, [43, 4], [45, 16]]]], ["block", "link-to", ["info.resources"], ["class", "cancel item"], 4, null, ["loc", [null, [46, 4], [48, 16]]]], ["block", "link-to", ["info.about"], ["class", "cancel item"], 5, null, ["loc", [null, [49, 4], [51, 16]]]]],
        locals: [],
    ...
    var child3 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          var el2 = dom.createTextNode("Something Missing?");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n  ");
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("p");
          var el2 = dom.createTextNode("If you know where else to keep cool, don't hesitate to ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("a");
          dom.setAttribute(el2, "href", "mailto:mgardner@mapc.org");
          var el3 = dom.createTextNode("reach out and let us know");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode(" so we can add it to our map!");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n  ");
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("h2");
          dom.setAttribute(el1, "class", "ui header");
          var el2 = dom.createTextNode("Legend");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n  ");
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("div");
          dom.setAttribute(el1, "class", "ui mini list");
          var el2 = dom.createTextNode("\n    ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("div");
          dom.setAttribute(el2, "class", "item");
          var el3 = dom.createElement("img");
          dom.setAttribute(el3, "src", "Map-icons-50x50-heat-01.png");
          dom.setAttribute(el3, "class", "ui middle aligned mini image");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("span");
          var el4 = dom.createTextNode("    Emergency Cooling Center");
          ...
          dom.setAttribute(el2, "class", "item");
          var el3 = dom.createElement("img");
          dom.setAttribute(el3, "src", "Map-icons-50x50-Beach-01.png");
          dom.setAttribute(el3, "class", "ui middle aligned mini image");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("span");
          var el4 = dom.createTextNode("    Beach");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          ...
          dom.setAttribute(el2, "class", "item");
          var el3 = dom.createElement("img");
          dom.setAttribute(el3, "src", "Map-icons-50x50-Library-01.png");
          dom.setAttribute(el3, "class", "ui middle aligned mini image");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("span");
          var el4 = dom.createTextNode("    Library");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          ...
          dom.setAttribute(el2, "class", "item");
          var el3 = dom.createElement("img");
          dom.setAttribute(el3, "src", "Map-icons-50x50-park-01.png");
          dom.setAttribute(el3, "class", "ui middle aligned mini image");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("span");
          var el4 = dom.createTextNode("    Park");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          ...
          dom.setAttribute(el2, "class", "item");
          var el3 = dom.createElement("img");
          dom.setAttribute(el3, "src", "Map-icons-50x50-Pool-01.png");
          dom.setAttribute(el3, "class", "ui middle aligned mini image");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("span");
          var el4 = dom.createTextNode("    Pool");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          ...
          dom.setAttribute(el2, "class", "item");
          var el3 = dom.createElement("img");
          dom.setAttribute(el3, "src", "Map-icons-50x50-SprayDeck-01.png");
          dom.setAttribute(el3, "class", "ui middle aligned mini image");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("span");
          var el4 = dom.createTextNode("    Spray Deck");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          ...
          dom.setAttribute(el2, "class", "item");
          var el3 = dom.createElement("img");
          dom.setAttribute(el3, "src", "Map-icons-50x50-Wading-01.png");
          dom.setAttribute(el3, "class", "ui middle aligned mini image");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("span");
          var el4 = dom.createTextNode("    Wading Pool");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          ...
          dom.setAttribute(el2, "class", "item");
          var el3 = dom.createElement("img");
          dom.setAttribute(el3, "src", "Map-icons-50x50-WaterPlay-01.png");
          dom.setAttribute(el3, "class", "ui middle aligned mini image");
          dom.appendChild(el2, el3);
          var el3 = dom.createElement("span");
          var el4 = dom.createTextNode("    Water Play");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n  ");
    ...
    var child4 = (function () {
      ...
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.setAttribute(el2, "class", "ui header red");
          ...
          var el3 = dom.createTextNode("\n      Why does it seem to be getting hotter? Learn the science behind the our warming climate.\n    ");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n");
          dom.appendChild(el1, el2);
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("h3");
          dom.setAttribute(el2, "class", "ui header orange");
          var el3 = dom.createTextNode("Stay safe in the high heat!");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n    ");
          dom.appendChild(el1, el2);
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("h3");
          dom.setAttribute(el2, "class", "ui header teal");
        ...
        statements: [["block", "link-to", ["info.why-is-it-so-hot"], ["class", "cancel item"], 0, null, ["loc", [null, [79, 4], [81, 16]]]], ["block", "link-to", ["info.heat-safety"], ["class", "cancel item"], 1, null, ["loc", [null, [88, 4], [90, 16]]]], ["block", "link-to", ["info.resources"], ["class", "cancel item"], 2, null, ["loc", [null, [96, 4], [98, 16]]]]],
        locals: [],
    ...
    return {
      ...
      statements: [["block", "if", [["get", "splash", ["loc", [null, [2, 8], [2, 14]]]]], [], 0, 1, ["loc", [null, [2, 2], [24, 9]]]], ["element", "action", ["openModal", "menu"], [], ["loc", [null, [26, 7], [26, 36]]]], ["block", "ui-modal", [], ["name", "profile", "class", "ui menu basic modal"], 2, null, ["loc", [null, [31, 0], [53, 13]]]], ["block", "ui-modal", [], ["name", "profile", "class", "ui legend basic scrollable modal"], 3, null, ["loc", [null, [55, 0], [70, 13]]]], ["block", "ui-modal", [], ["name", "profile", "class", "ui learn basic modal"], 4, null, ["loc", [null, [72, 0], [100, 13]]]], ["content", "yield", ["loc", [null, [102, 0], [102, 9]]]]],
      locals: [],
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      ...
      var child1 = (function () {
        var child0 = (function () {
          var child0 = (function () {
            return {
              ...
              statements: [["attribute", "data-value", ["concat", [["get", "group.content.firstObject.name", ["loc", [null, [52, 57], [52, 87]]]]]]], ["content", "group.group", ["loc", [null, [52, 95], [52, 110]]]]],
              locals: [],
              templates: []
            };
          })();
          var child1 = (function () {
            var child0 = (function () {
              return {
                ...
                statements: [["content", "town.name", ["loc", [null, [57, 42], [57, 55]]]]],
                locals: [],
                templates: []
              };
            })();
            var child1 = (function () {
              return {
                ...
                statements: [["content", "town.name", ["loc", [null, [59, 26], [59, 39]]]]],
                locals: [],
                templates: []
              };
            })();
            return {
              ...
              statements: [["attribute", "data-value", ["concat", [["get", "town.name", ["loc", [null, [55, 54], [55, 63]]]]]]], ["block", "if", [["get", "group.multiple", ["loc", [null, [56, 30], [56, 44]]]]], [], 0, 1, ["loc", [null, [56, 24], [60, 31]]]]],
              locals: ["town"],
          ...
          return {
            ...
            statements: [["block", "if", [["get", "group.multiple", ["loc", [null, [51, 26], [51, 40]]]]], [], 0, null, ["loc", [null, [51, 20], [53, 27]]]], ["block", "each", [["get", "group.content", ["loc", [null, [54, 28], [54, 41]]]]], [], 1, null, ["loc", [null, [54, 20], [63, 29]]]]],
            locals: ["group"],
            templates: [child0, child1]
          };
        })();
        return {
          ...
          statements: [["block", "each", [["get", "grouped", ["loc", [null, [50, 26], [50, 33]]]]], [], 0, null, ["loc", [null, [50, 18], [64, 27]]]]],
          locals: [],
          templates: [child0]
        };
      })();
      return {
        ...
        buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
          var element2 = dom.childAt(fragment, [1, 3, 1, 1]);
          var morphs = new Array(2);
          morphs[0] = dom.createMorphAt(element2, 1, 1);
          morphs[1] = dom.createMorphAt(dom.childAt(element2, [3, 1]), 1, 1);
          return morphs;
        },
        statements: [["block", "unless", [["get", "geolocation.disabled", ["loc", [null, [24, 22], [24, 42]]]]], [], 0, null, ["loc", [null, [24, 12], [40, 23]]]], ["block", "ui-dropdown", [], ["class", "small fluid selection optgroup", "onChange", ["subexpr", "action", ["toTown"], [], ["loc", [null, [44, 79], [44, 96]]]]], 1, null, ["loc", [null, [44, 16], [66, 32]]]]],
        locals: [],
        templates: [child0, child1]
      };
    })();
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        morphs[2] = dom.createMorphAt(dom.childAt(element3, [1, 5]), 1, 1);
        morphs[3] = dom.createMorphAt(dom.childAt(element3, [3, 5]), 1, 1);
        morphs[4] = dom.createMorphAt(dom.childAt(element3, [5, 5]), 1, 1);
        dom.insertBoundary(fragment, 0);
        return morphs;
      },
      statements: [["inline", "header-menu", [], ["forecast", ["subexpr", "@mut", [["get", "model.weather.forecast", ["loc", [null, [2, 11], [2, 33]]]]], [], []], "current_temp", ["subexpr", "@mut", [["get", "model.weather.current_temp", ["loc", [null, [3, 15], [3, 41]]]]], [], []], "heat_alert", ["subexpr", "@mut", [["get", "model.weather.heat_alert", ["loc", [null, [4, 13], [4, 37]]]]], [], []], "splash", true], ["loc", [null, [1, 0], [5, 15]]]], ["block", "splash-weather", [], ["heat_alert", ["subexpr", "gt", [["get", "model.weather.forecast", ["loc", [null, [8, 35], [8, 57]]]], "37"], [], ["loc", [null, [8, 31], [8, 63]]]]], 0, null, ["loc", [null, [8, 2], [80, 21]]]], ["block", "link-to", ["info.why-is-it-so-hot"], ["class", "ui red basic button"], 1, null, ["loc", [null, [90, 6], [92, 18]]]], ["block", "link-to", ["info.heat-safety"], ["class", "ui orange basic button"], 2, null, ["loc", [null, [102, 6], [104, 18]]]], ["block", "link-to", ["info.resources"], ["class", "ui teal basic button"], 3, null, ["loc", [null, [114, 6], [116, 18]]]]],
      locals: [],
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("p");
        var el4 = dom.createTextNode("\n      Keep Cool is a pilot initiative of the ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("p");
        var el4 = dom.createTextNode(" Keep Cool datasets were collected from a wide host of sources and collaborators including: MassGIS, The Boston Office of Environment, Energy, and Open Space: Greenovate, Member Municipalities of the Metro Mayor's Coalition, and Boston's Center for Youth and Families (BCYF).\n    ");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n  ");
        dom.appendChild(el2, el3);
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el3 = dom.createTextNode("Keep cool, ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("br");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("we're loading...");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
    ...
    var child0 = (function () {
      var child0 = (function () {
        ...
        var child9 = (function () {
          return {
            ...
            statements: [["inline", "marker-layer", [], ["lat", ["subexpr", "@mut", [["get", "place.latitude", ["loc", [null, [46, 29], [46, 43]]]]], [], []], "lng", ["subexpr", "@mut", [["get", "place.longitude", ["loc", [null, [46, 48], [46, 63]]]]], [], []], "onClick", ["subexpr", "action", ["viewPlace", ["get", "place", ["loc", [null, [46, 92], [46, 97]]]]], [], ["loc", [null, [46, 72], [46, 98]]]], "icon", ["subexpr", "@mut", [["get", "library", ["loc", [null, [46, 104], [46, 111]]]]], [], []]], ["loc", [null, [46, 10], [46, 113]]]]],
            locals: [],
            templates: []
          };
        })();
        var child10 = (function () {
          var child0 = (function () {
            return {
              ...
              statements: [["inline", "marker-layer", [], ["lat", ["subexpr", "@mut", [["get", "place.latitude", ["loc", [null, [51, 31], [51, 45]]]]], [], []], "lng", ["subexpr", "@mut", [["get", "place.longitude", ["loc", [null, [51, 50], [51, 65]]]]], [], []], "onClick", ["subexpr", "action", ["viewPlace", ["get", "place", ["loc", [null, [51, 94], [51, 99]]]]], [], ["loc", [null, [51, 74], [51, 100]]]], "icon", ["subexpr", "@mut", [["get", "heat", ["loc", [null, [51, 106], [51, 110]]]]], [], []]], ["loc", [null, [51, 12], [51, 112]]]]],
              locals: [],
              templates: []
            };
          })();
          var child1 = (function () {
            return {
              ...
              statements: [["inline", "marker-layer", [], ["lat", ["subexpr", "@mut", [["get", "place.latitude", ["loc", [null, [54, 31], [54, 45]]]]], [], []], "lng", ["subexpr", "@mut", [["get", "place.longitude", ["loc", [null, [54, 50], [54, 65]]]]], [], []], "onClick", ["subexpr", "action", ["viewPlace", ["get", "place", ["loc", [null, [54, 94], [54, 99]]]]], [], ["loc", [null, [54, 74], [54, 100]]]], "icon", ["subexpr", "@mut", [["get", "heat", ["loc", [null, [54, 106], [54, 110]]]]], [], []]], ["loc", [null, [54, 12], [54, 112]]]]],
              locals: [],
              templates: []
            };
          })();
          return {
            ...
            statements: [["block", "if", [["subexpr", "eq", [["get", "place.first_type", ["loc", [null, [50, 20], [50, 36]]]], "BCYF Cooling Center"], [], ["loc", [null, [50, 16], [50, 59]]]]], [], 0, null, ["loc", [null, [50, 10], [52, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "place.first_type", ["loc", [null, [53, 20], [53, 36]]]], "Cooling Center"], [], ["loc", [null, [53, 16], [53, 54]]]]], [], 1, null, ["loc", [null, [53, 10], [55, 17]]]]],
            locals: [],
            templates: [child0, child1]
          };
        })();
      ...
      var child1 = (function () {
        return {
          ...
          statements: [["inline", "marker-layer", [], ["location", ["subexpr", "@mut", [["get", "geolocation.currentLocation", ["loc", [null, [61, 30], [61, 57]]]]], [], []], "icon", ["subexpr", "@mut", [["get", "callOutMarker", ["loc", [null, [61, 63], [61, 76]]]]], [], []]], ["loc", [null, [61, 6], [61, 78]]]]],
          locals: [],
          templates: []
        };
      })();
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        statements: [["content", "model.hours", ["loc", [null, [11, 38], [11, 53]]]]],
        locals: [],
        templates: []
      };
    })();
    var child1 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("p");
          var el2 = dom.createTextNode("Hours Unavailable");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
          dom.appendChild(el0, el1);
    ...
    var child2 = (function () {
      return {
        ...
        statements: [["attribute", "href", ["concat", ["tel:", ["get", "model.phone", ["loc", [null, [16, 24], [16, 35]]]]]]], ["content", "model.phone", ["loc", [null, [16, 69], [16, 84]]]]],
        locals: [],
        templates: []
      };
    })();
    var child3 = (function () {
      var child0 = (function () {
        return {
          ...
          buildFragment: function buildFragment(dom) {
            ...
            dom.setAttribute(el1, "src", "Map-icons-50x50-Beach-01.png");
            dom.setAttribute(el1, "class", "ui avatar image");
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
            return el0;
      ...
      var child1 = (function () {
        return {
          ...
          buildFragment: function buildFragment(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("img");
            dom.setAttribute(el1, "src", "Map-icons-50x50-Wading-01.png");
            dom.setAttribute(el1, "class", "ui avatar image");
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
      ...
      var child4 = (function () {
        return {
          ...
          buildFragment: function buildFragment(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("img");
            dom.setAttribute(el1, "src", "Map-icons-50x50-Pool-01.png");
            dom.setAttribute(el1, "class", "ui avatar image");
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
      ...
      var child7 = (function () {
        return {
          ...
          buildFragment: function buildFragment(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("img");
            dom.setAttribute(el1, "src", "Map-icons-50x50-SprayDeck-01.png");
            dom.setAttribute(el1, "class", "ui avatar image");
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
      ...
      var child8 = (function () {
        return {
          ...
          buildFragment: function buildFragment(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("img");
            dom.setAttribute(el1, "src", "Map-icons-50x50-WaterPlay-01.png");
            dom.setAttribute(el1, "class", "ui avatar image");
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
      ...
      var child9 = (function () {
        return {
          ...
          buildFragment: function buildFragment(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("img");
            dom.setAttribute(el1, "src", "Map-icons-50x50-Library-01.png");
            dom.setAttribute(el1, "class", "ui avatar image");
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
      ...
      var child10 = (function () {
        return {
          ...
          buildFragment: function buildFragment(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("img");
            dom.setAttribute(el1, "src", "Map-icons-50x50-heat-01.png");
            dom.setAttribute(el1, "class", "ui avatar image");
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
      ...
      return {
        ...
        buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
          ...
          morphs[12] = dom.createMorphAt(dom.childAt(element0, [25, 1]), 1, 1);
          return morphs;
        },
        statements: [["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [24, 20], [24, 24]]]], "Beach"], [], ["loc", [null, [24, 16], [24, 33]]]]], [], 0, null, ["loc", [null, [24, 10], [26, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [28, 20], [28, 24]]]], "Wading Pool"], [], ["loc", [null, [28, 16], [28, 39]]]]], [], 1, null, ["loc", [null, [28, 10], [30, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [32, 20], [32, 24]]]], "Pond"], [], ["loc", [null, [32, 16], [32, 32]]]]], [], 2, null, ["loc", [null, [32, 10], [34, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [36, 20], [36, 24]]]], "Lake"], [], ["loc", [null, [36, 16], [36, 32]]]]], [], 3, null, ["loc", [null, [36, 10], [38, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [40, 20], [40, 24]]]], "Diving Pool"], [], ["loc", [null, [40, 16], [40, 39]]]]], [], 4, null, ["loc", [null, [40, 10], [42, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [44, 20], [44, 24]]]], "Swimming Pool"], [], ["loc", [null, [44, 16], [44, 41]]]]], [], 5, null, ["loc", [null, [44, 10], [46, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [48, 20], [48, 24]]]], "Swimming"], [], ["loc", [null, [48, 16], [48, 36]]]]], [], 6, null, ["loc", [null, [48, 10], [50, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [52, 20], [52, 24]]]], "Spray Deck"], [], ["loc", [null, [52, 16], [52, 38]]]]], [], 7, null, ["loc", [null, [52, 10], [54, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [56, 20], [56, 24]]]], "Water Play"], [], ["loc", [null, [56, 16], [56, 38]]]]], [], 8, null, ["loc", [null, [56, 10], [58, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [60, 20], [60, 24]]]], "Library"], [], ["loc", [null, [60, 16], [60, 35]]]]], [], 9, null, ["loc", [null, [60, 10], [62, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [64, 20], [64, 24]]]], "BCYF Cooling Center"], [], ["loc", [null, [64, 16], [64, 47]]]]], [], 10, null, ["loc", [null, [64, 10], [66, 17]]]], ["block", "if", [["subexpr", "eq", [["get", "type", ["loc", [null, [68, 20], [68, 24]]]], "Cooling Center"], [], ["loc", [null, [68, 16], [68, 42]]]]], [], 11, null, ["loc", [null, [68, 10], [70, 17]]]], ["content", "type", ["loc", [null, [74, 14], [74, 22]]]]],
        locals: ["type"],
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3, "class", "ui inverted horizontal divider");
        var el4 = dom.createTextNode("\n      Information\n    ");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n");
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3, "class", "ui inverted list");
        var el4 = dom.createTextNode("\n");
        dom.appendChild(el3, el4);
        var el4 = dom.createComment("");
        dom.appendChild(el3, el4);
...
define('cool-places/utils/group-by', ['exports'], function (exports) {
  var get = Ember.get;

  exports['default'] = function (groupBy, property) {
...
define('cool-places/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"cool-places","environment":"production","baseURL":"/cool-places/","locationType":"hash","contentSecurityPolicy":{"connect-src":"'self' https://auth.firebase.com wss://*.firebaseio.com http://*.cartodb.com http://*.basemaps.cartocdn.com http://api.wunderground.com https://query.yahooapis.com","img-src":"'self' http://*.basemaps.cartocdn.com/ data: https://p.typekit.net https://api.mapbox.com","font-src":"'self' data: https://fonts.typekit.net","style-src":"'self' 'unsafe-inline'","script-src":"'self' 'unsafe-eval' 'unsafe-inline' localhost:49152 0.0.0.0:49152 http://use.typekit.net https://use.typekit.net","default-src":"'none'","media-src":"'self'"},"EmberENV":{"FEATURES":{}},"APP":{"name":"cool-places","version":"0.0.0+17d7a56d","autoboot":false},"manifest":{"enabled":true,"appcacheFile":"/manifest.appcache","excludePaths":["index.html"],"includePaths":["/"],"network":["api/"],"showCreateDate":true},"MMC_towns":["Boston","Cambridge","Chelsea","Everett","Malden","Melrose","Medford","Quincy","Revere","Somerville","Brookline","Winthrop","Braintree","Newton"],"datacollection":true,"typekit":{"kitId":"brw3zbp","sync":false,"timeout":3000},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","exportApplicationGlobal":false}};
});
